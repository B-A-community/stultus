...
module BACommunity
  module Stultus
    module Runner
      ...
      # transparent: true — операция сливается с предыдущим пунктом Undo.
      # Окно этим больше не пользуется (с 0.2.27): каждый вызов модели —
      # свой пункт, иначе после отмены следующий вызов сливался с
      # действием пользователя под ним. Журнал шагов — undo_ledger.rb.
      #
