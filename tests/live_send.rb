...
d.execute_script("document.getElementById('providerSelect').value='claude'; document.getElementById('providerSelect').dispatchEvent(new Event('change')); document.getElementById('input').value=#{text.to_json}; document.getElementById('btnSend').click();")
